...
router.get("/rolePermissions/", [authJwt.verifyTokenSQL], moduleAdminCtrl.getPermissionsByRole);
...
router.post("/backupDB/", [authJwt.verifyTokenSQL], moduleAdminCtrl.postBackupDB);
router.post("/backupDB2/", [authJwt.verifyTokenSQL], moduleAdminCtrl.postBackupDB2);
...
router.put("/jobs/:ID_PUESTO", [authJwt.verifyTokenSQL], moduleAdminCtrl.updateJob); //Para actualizar usuario

router.put("/updateUser/:ID_USUARIO", [authJwt.verifyTokenSQL, _upload["default"].uploadUserIMG], moduleAdminCtrl.updateUserByAdmin);
var _default = router;
