...
import { Category, Product, Sale } from '../interfaces/objects.interface';
...
export class InventarioService {
  ...
  obtenerCategorias(): Observable<any>{
    return this.http.get<Category>(`${this.bUA}/module/inventory/category`);
  }
  ...
  obtenerInventario(): Observable<any>{
    return this.http.get<any>(`${this.bUA}/module/inventory`);
  }

  //funcion para obtener productos con existencia en inventario
  obtenerExistenciaInventario(): Observable<any>{
    return this.http.get<any>(`${this.bUA}/module/inventory/existence`);
  }
